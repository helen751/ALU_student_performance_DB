...
JOIN linux_grades lg ON s.student_id = lg.student_id --adding of linux grades to each student based on their srudent id
JOIN python_grades pg ON s.student_id = pg.student_id --adding of python grades to each student based on their srudent id

ORDER BY average_grade DESC -- Arrages students from highest to lowest
